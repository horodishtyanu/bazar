...
/**
 * BSaleOrderPropsRelOld
 *
 * @ORM\Table(name="b_sale_order_props_rel_old", indexes={@ORM\Index(name="IX_PROPERTY", columns={"PROPERTY_ID"}), @ORM\Index(name="IX_ENTITY_ID", columns={"ENTITY_ID"})})
 * @ORM\Entity
 */
class BSaleOrderPropsRelOld
{
    /**
     * @var int
     *
